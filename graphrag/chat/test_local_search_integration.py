...
def test_local_search_with_distribution_template():
    """Test integration with the 'distribution' template"""
    # Get template tuple
    template_tuple = PROMPT_TEMPLATES["distribution"]
    query = "Show me the monthly distribution of unit sales for Anaconda Automotive Holdings over the past year"
    # Format template with required variables
    response_type = template_tuple[1]
