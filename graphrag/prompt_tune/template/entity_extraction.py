...
{{"source": <source_entity>, "target": <target_entity>, "relationship_type": <relationship_type>, "relationship": <relationship_description>, "relationship_strength": <relationship_strength>}}
